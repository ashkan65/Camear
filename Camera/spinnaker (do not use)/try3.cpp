        ...
        while(1)
        {
            try
            {
                ...
                else
                {
                    ...
                    // ImagePtr pResultImage2 = pResultImage->Convert(PixelFormat_BGR8, NEAREST_NEIGHBOR);
                    ...
                    CurrentImage = cv::Mat(rowsize, colsize, CV_8UC3, pResultImage->GetData(), pResultImage->GetStride());
                    cv::imshow("IMG1", CurrentImage);
